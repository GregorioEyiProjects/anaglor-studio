...
const Hero = () => {
  return (
    <section
      id="top"
      className="relative flex min-h-svh items-end overflow-hidden bg-black text-white lg:items-center"
    >
      <img
        src={heroImage}
      ...
      <div className="relative mx-auto w-full max-w-360 px-6 pb-12 pt-28 lg:px-8 lg:py-20">
        <div className="hero-copy" data-reveal>
          ...
          <p className="mt-6 max-w-xl text-sm leading-7 text-ag-soft-white lg:text-lg lg:leading-8">
          ...
          <ul className="mt-9 flex flex-wrap text-ag-white gap-x-6 gap-y-3 border-t border-white/20 pt-5 text-xs uppercase tracking-[0.14em] ">
