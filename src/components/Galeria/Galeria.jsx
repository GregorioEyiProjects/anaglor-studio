...
const Galeria = () => {
  ...
  const fotos = mediaSincronizada.length > 0 ? mediaSincronizada.slice(0, 4) : FOTOS;
        ...
        {fotos.map((foto, index) => (
          ...
          >
            <img
              ...
              data-parallax
            />
            <span className="absolute inset-x-0 bottom-0 flex items-center justify-between bg-gradient-to-t from-black/85 to-transparent px-4 pb-4 pt-12 text-[10px] font-medium uppercase tracking-[0.12em] text-white sm:text-xs">
              {foto.label}
              <FontAwesomeIcon
