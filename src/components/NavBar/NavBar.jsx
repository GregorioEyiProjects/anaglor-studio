...
const NavBar = () => {
  ...
  return (
    <nav
      className="fixed inset-x-0 top-0 z-50 px-3 pt-3 text-white sm:px-5 lg:px-8"
    >
      <div
        className={`liquid-glass liquid-glass-nav mx-auto flex h-16 max-w-[1440px] items-center justify-between overflow-hidden rounded-lg px-4 transition-colors duration-500 sm:px-5 lg:px-6 ${
